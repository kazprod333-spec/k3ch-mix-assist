...
class MasterOutputMeter final : public juce::Component, private juce::Timer
{
public:
    explicit MasterOutputMeter (MasterProcessor& processor);
    ~MasterOutputMeter() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MasterOutputMeter)
};
